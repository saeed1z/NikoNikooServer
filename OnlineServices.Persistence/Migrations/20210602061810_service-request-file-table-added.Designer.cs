...
namespace OnlineServices.Persistence.Migrations
{
    ...
    [Migration("20210602061810_service-request-file-table-added")]
    partial class servicerequestfiletableadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineServices.Entity.CommercialUserRequest", b =>
                {
                    ...
                    b.Property<string>("InterfaceFamily")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("CommercialUserRequest");
                });
            ...
            modelBuilder.Entity("OnlineServices.Entity.Message", b =>
                {
                    ...
                    b.Property<Guid?>("ServiceFactorId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnlineServices.Entity.Person", b =>
                {
                    ...
                    b.Property<string>("BuildingPlate")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OnlineServices.Entity.ServiceFactor", b =>
                {
                    ...
                    b.Property<string>("SalesShop")
                        .IsRequired()
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("SalesShopAddress")
                        .IsRequired()
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("SalesShopPhone")
                        .IsRequired()
            ...
            modelBuilder.Entity("OnlineServices.Entity.ServiceRequest", b =>
                {
                    ...
                    b.Property<Guid?>("ParentServiceRequestId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnlineServices.Entity.ServiceRequestFile", b =>
                {
                    ...
                    b.Property<string>("RequestFileExtension")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OnlineServices.Entity.ServiceRequestSurvey", b =>
                {
                    ...
                    b.Property<int>("ServiceTypeQuestionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ServiceTypeQuestionId");

                    b.ToTable("ServiceRequestSurvey");
                });
            ...
            modelBuilder.Entity("OnlineServices.Entity.Message", b =>
                {
                    ...
                    b.HasOne("OnlineServices.Entity.ServiceFactor", null)
                        .WithMany("Message")
            ...
            modelBuilder.Entity("OnlineServices.Entity.ServiceFactorDetail", b =>
                {
                    b.HasOne("OnlineServices.Entity.ServiceFactor", "ServiceFactor")
                        .WithMany("ServiceFactorDetail")
                        .HasForeignKey("ServiceFactorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("OnlineServices.Entity.ServiceRequest", b =>
                {
                    ...
                    b.HasOne("OnlineServices.Entity.ServiceRequest", "ParentServiceRequest")
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineServices.Entity.ServiceRequestSurvey", b =>
                {
                    ...
                    b.HasOne("OnlineServices.Entity.ServiceTypeQuestion", "ServiceTypeQuestion")
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineServices.Entity.TicketComments", b =>
                {
                    b.HasOne("OnlineServices.Entity.Ticket", "Ticket")
                        .WithMany("TicketCommecnts")
