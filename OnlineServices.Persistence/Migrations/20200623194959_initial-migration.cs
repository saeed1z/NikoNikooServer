        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PanelAccess = table.Column<bool>(nullable: false),
                    ServiceAppAccess = table.Column<bool>(nullable: false),
                    UserAppAccess = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeNo = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonService", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PersonService_Person_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Person",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonService_ServiceType_ServiceTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonService_ServiceTypeId",
                table: "PersonService",
